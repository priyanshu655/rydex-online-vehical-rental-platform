    ...
    <>
                    ...
                    {profileOpen && (
                      ...
                      >
                        <div className="p-5">
                          ...
                          <button
                            className="hover:bg-gray-100 rounded-xl mt-2 w-full flex items-center gap-3 py-3"
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          left-1/2 -translate-x-1/2 w-[92%] bg-[#0B0B0B] rounded-2xl shadow-2xl z-40 md:hidden overflow-hidden"
            >
